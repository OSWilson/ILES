...
Overview
The Internship Management System aka Internship Logging and Evaluation System(ILES) is a web-based application built with Django that helps manage internship placements, student records,and supervisor evaluations.
Features
